...
(
 ROLLBACK_TIME TIMESTAMP(6) FORMAT 'YYYY-MM-DDBHH:MI:SS.S(6)BZ ' NOT NULL DEFAULT Timestamp '9999-12-31 11:59:00' , 
...
ALTER NICKNAME !appschema!.IBMQREP_ROLLBACK_R 
	ALTER COLUMN ROW_NUMBER_TEMP LOCAL NAME ROW_NUMBER;
...
CREATE INDEX IX1EXCEPTIONS ( EXCEPTION_TIME)  ON "!remote_schema!"."IBMQREP_EXCEPTIONS"; 
