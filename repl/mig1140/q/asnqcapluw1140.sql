...
ALTER TABLE !CAPSCHEMA!.IBMQREP_CAPPARMS ADD COLUMN REMOTE_SOURCE_DB_LOC VARCHAR(128) WITH DEFAULT NULL;
ALTER TABLE !CAPSCHEMA!.IBMQREP_CAPPARMS ADD COLUMN ON_REMOTE_SOURCE_UNAVAIL CHARACTER(1) WITH DEFAULT NULL;
