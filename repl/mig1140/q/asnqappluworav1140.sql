...
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD NUM_STREAM_AGENTS NUMBER(10) DEFAULT 0;
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD CAPTURE_LEVEL VARCHAR2(10) DEFAULT NULL;
...
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TRG_COLS  ADD IS_PART_KEY NUMBER(5) DEFAULT 0 NOT NULL;
...
ALTER NICKNAME !APPSCHEMA!.IBMQREP_RECVQUEUES
 ALTER COLUMN NUM_STREAM_AGENTS LOCAL TYPE INTEGER;

ALTER NICKNAME !APPSCHEMA!.IBMQREP_TRG_COLS
 ALTER COLUMN IS_PART_KEY LOCAL TYPE INTEGER;
