...
--                                                                   */
--********************************************************************/
-- Script to migrate SQL Server Q Apply control tables from V11.1 to V11.5 
-- or higher
...
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD HAS_FILERECV CHARACTER(1) DEFAULT 'N';
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD NUM_STREAM_AGENTS INTEGER DEFAULT 0;
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD CAPTURE_LEVEL VARCHAR(10) DEFAULT NULL;

ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TARGETS  ADD HAS_PARTS CHARACTER(1) DEFAULT 'N';
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TARGETS  ADD SOURCE_IS_COLUMNAR CHARACTER(1) DEFAULT 'N';

ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TRG_COLS  ADD IS_PART_KEY SMALLINT NOT NULL DEFAULT 0;
...
ALTER NICKNAME !APPSCHEMA!.IBMQREP_TARGETS
