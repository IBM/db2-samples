...
public class sample3  {
  ...
  public static void main(String args[]) {
    ...
    String qManager  = parseArgsFor("-qmgr", args);     // get the -qmgr argument
  ...
  protected static void printHelp() {
    System.out.println("Usage:  java sample3 -qmgr <queueManager> (-queue <queue name> | -topic <topic name>) ");
    System.out.println("  example:  java sample3 -qmgr DefaultQMGR -queue myPubQ");
    System.out.println("          - or -       ");
    System.out.println("  example:  java sample3 -qmgr DefaultQMGR -topic myTopic");
  }
