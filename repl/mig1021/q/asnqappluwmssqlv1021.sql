...
--                                                                   */
--********************************************************************/
-- Script to migrate SQL Server Q Apply control tables from V10 
...
(
 ...
 MAX_CMT_SEQ_READ VARBINARY(16) NOT NULL ,
 MAX_CMT_TIME_READ DATETIME2 NOT NULL ,
 NUM_ACTIVE_CGS SMALLINT NOT NULL ,
 LOWEST_MCG_MAX_CMT_SEQ_READ VARBINARY(16) NOT NULL ,
 LOWEST_MCG_OLDEST_TRANS DATETIME2 NOT NULL ,
 NEXT_APPLYUPTO_TIME DATETIME2 ,
 NUM_TRANS_MCG_DELAY INTEGER NOT NULL ,
 CURRENT_NUM_TRANS INTEGER NOT NULL ,
 CURRENT_NUM_MSGS INTEGER NOT NULL ,
 MCG_REFRESH_TIME DATETIME2 NOT NULL ,
