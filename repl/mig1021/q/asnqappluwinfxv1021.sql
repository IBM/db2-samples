...
--                                                                   */
--********************************************************************/
-- Script to migrate Informix Q Apply control tables from V10 
...
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD BIDIAPPLY_SCHEMA VARCHAR(128) DEFAULT NULL;
...
(
 MONITOR_TIME DATETIME YEAR TO FRACTION(5) NOT NULL ,
 MCGNAME VARCHAR(64) NOT NULL ,
 RECVQ VARCHAR(48) NOT NULL ,
 MAX_CMT_SEQ_READ BYTE NOT NULL ,
 MAX_CMT_TIME_READ DATETIME YEAR TO FRACTION(5) NOT NULL ,
 NUM_ACTIVE_CGS SMALLINT NOT NULL ,
 LOWEST_MCG_MAX_CMT_SEQ_READ BYTE NOT NULL ,
 LOWEST_MCG_OLDEST_TRANS DATETIME YEAR TO FRACTION(5) NOT NULL ,
 NEXT_APPLYUPTO_TIME DATETIME YEAR TO FRACTION(5) ,
 NUM_TRANS_MCG_DELAY INTEGER NOT NULL ,
 CURRENT_NUM_TRANS INTEGER NOT NULL ,
 CURRENT_NUM_MSGS INTEGER NOT NULL ,
 MCG_REFRESH_TIME DATETIME YEAR TO FRACTION(5)  NOT NULL ,
