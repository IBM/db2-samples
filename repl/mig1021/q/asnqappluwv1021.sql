...
--                                                                   */
--********************************************************************/
-- Script to migrate Q Apply control tables from V10 or V105FP[1-6] to V105FP7 or higher.
-- Q Apply Migration script (asnqappluwv1021.sql)
...
ALTER TABLE !APPSCHEMA!.IBMQREP_RECVQUEUES ADD COLUMN MCGNAME VARCHAR(64) WITH DEFAULT NULL;

ALTER TABLE !APPSCHEMA!.IBMQREP_RECVQUEUES ADD COLUMN AGENT_STMT_CACHE_SZ INTEGER NOT NULL WITH DEFAULT 300;

ALTER TABLE !APPSCHEMA!.IBMQREP_RECVQUEUES ADD COLUMN MRI_MEMORY_LIMIT INTEGER NOT NULL WITH DEFAULT 1024;

ALTER TABLE !APPSCHEMA!.IBMQREP_RECVQUEUES ADD COLUMN BIDIAPPLY_SCHEMA VARCHAR(128) DEFAULT NULL;
...
ALTER TABLE !APPSCHEMA!.IBMQREP_TARGETS ADD COLUMN REPL_DROP_COL CHAR(1) WITH DEFAULT 'Y';
ALTER TABLE !APPSCHEMA!.IBMQREP_TARGETS ADD COLUMN REPL_RENAME_COL CHAR(1) WITH DEFAULT 'Y';
ALTER TABLE !APPSCHEMA!.IBMQREP_TARGETS ADD COLUMN REPL_ALTER_COL CHAR(1) WITH DEFAULT 'Y';
ALTER TABLE !APPSCHEMA!.IBMQREP_TARGETS ADD COLUMN SRC_LOCATION_ALIAS VARCHAR(16) WITH DEFAULT NULL;
...
(
 ...
 LOWEST_MCG_MAX_CMT_SEQ_READ VARCHAR(16) FOR BIT DATA NOT NULL,
...
CREATE UNIQUE INDEX !APPSCHEMA!.IX1MCGMON ON !APPSCHEMA!.IBMQREP_MCGMON
(
 MONITOR_TIME ASC,
 RECVQ
);
...
-- Do not change the ASN schema for the following 2 MCG tables
