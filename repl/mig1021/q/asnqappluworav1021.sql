...
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD MCGNAME VARCHAR2(64) DEFAULT NULL;

ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD AGENT_STMT_CACHE_SZ NUMBER(10) DEFAULT 300 NOT NULL;

ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD MRI_MEMORY_LIMIT NUMBER(10) DEFAULT 1024 NOT NULL;

ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_RECVQUEUES ADD BIDIAPPLY_SCHEMA VARCHAR2(128) DEFAULT NULL;

ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TARGETS ADD REPL_DROP_COL CHAR(1) DEFAULT 'Y';
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TARGETS ADD REPL_RENAME_COL CHAR(1) DEFAULT 'Y';
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TARGETS ADD REPL_ALTER_COL CHAR(1) DEFAULT 'Y';
ALTER TABLE !REMOTE_SCHEMA!.IBMQREP_TARGETS ADD SRC_LOCATION_ALIAS VARCHAR2(16) DEFAULT NULL;
...
ALTER COLUMN NUM_APPLY_AGENTS
 LOCAL TYPE INTEGER
 ALTER COLUMN MEMORY_LIMIT LOCAL TYPE INTEGER

 ALTER COLUMN MAXAGENTS_CORRELID LOCAL TYPE INTEGER
 ALTER COLUMN
 AGENT_STMT_CACHE_SZ LOCAL TYPE INTEGER
 ALTER COLUMN MRI_MEMORY_LIMIT
 LOCAL TYPE INTEGER;
...
ALTER NICKNAME !APPSCHEMA.IBMQREP_MCGMON
 ALTER COLUMN NUM_ACTIVE_CGS LOCAL
 TYPE SMALLINT
 ALTER COLUMN NUM_TRANS_MCG_DELAY LOCAL TYPE INTEGER

 ALTER COLUMN CURRENT_NUM_TRANS LOCAL TYPE INTEGER
 ALTER COLUMN
 CURRENT_NUM_MSGS LOCAL TYPE INTEGER;
