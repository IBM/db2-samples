...
--                                                                   */
--********************************************************************/
-- File name: asnqappluwinfxv10fp.sql
--
...
--     to the name of the federated Informix data source
-- (2) Locate and change all occurrences of the string !remote_schema!
--     to the name of owner of the Informix tables
...
ALTER NICKNAME !appschema!.IBMQREP_EXCEPTIONS
 ...
 ALTER COLUMN SRC_TRANS_ID LOCAL TYPE VARCHAR(48) FOR BIT DATA
 ALTER COLUMN SRC_INTENTSEQ LOCAL TYPE VARCHAR(48) FOR BIT DATA;
