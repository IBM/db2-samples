...
--
-- Source File Name: saBankDemoSpatialSQL.db2
--
-- Version:          11.5.6+
--
-- Description:      examples spatial routines
--                   unless specified geometries use the default SRSID of 4326 (WGS-84).
--
...
-- ST_Area(geometry)
--===============================================================
--!db2se drop_srs sa_bank -srsName new_york1983 -sa 1;

--!db2se create_srs sa_bank  -srsId 4000 -srsName new_york1983 -xOffset 0 -yOffset 0 -xScale 1 -yScale 1 -coordsysName NAD_1983_StatePlane_New_York_East_FIPS_3101_Feet -sa 1;
...
--VALUES
--    (1, 'st_point', ST_Point(50, 50) ),
--    (2, 'st_linestring', ST_LineString('linestring(200 100, 210 130, 220 140)') ),
--    (3, 'st_polygon', ST_Polygon('polygon((110 120, 110 140, 130 140, 130 120, 110 120))') );
...
--SELECT id, spatial_type, cast(ST_AsGeoJSON(geometry) AS varchar(150)) AS wkt
--FROM   sample_geometries;
...
--SELECT id, spatial_type, 
--       cast(ST_AsText(ST_Buffer(geometry, 10)) AS varchar(470)) AS buffer,
...
--VALUES
--    (1, ST_Point(10, 20)),
--    (2, ST_Point('point(41 41)'));

--INSERT INTO sample_lines (id, geometry)
--VALUES
--    (10, ST_LineString('linestring (1 10, 3 12, 10 10)') ),
--    (20, ST_LineString('linestring (50 10, 50 12, 45 10)') );

--INSERT INTO sample_polygons(id, geometry) 
--VALUES
--      (100, ST_Polygon('polygon((0 0, 0 40, 40 40, 40 0, 0 0))') );
...
--INSERT INTO sample_geometries(id, spatial_type, geometry) 
--VALUES
--    (1, 'ST_LineString', ST_LineString('linestring(20 20, 30 30, 20 40, 30 50)') ),
--    (2, 'ST_Polygon', ST_Polygon('polygon((110  120,  110 140, 120 130, 110 120))', 0) ),
--    (3, 'ST_Polygon', ST_Polygon('polygon((30 30, 25 35, 15 50, 35 80, 40 85, 80 90, 70 75, 65 70, 55 50, 75 40, 60 30, 30 30))') ),
--    (4, 'ST_MultiPoint', ST_MultiPoint('multipoint(20 20, 30 30, 20 40, 30 50)') );

--SELECT id, spatial_type, cast(ST_AsText(ST_ConvexHull(geometry)) AS varchar(300)) AS convexhull
--FROM   sample_geometries;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(340)) AS GeomCollection
--FROM   sample_geomcollections;
...
--SELECT id, cast(ST_AsText(ST_GeomCollFromWKB(wkb)) AS varchar(190)) AS GeomCollection
--FROM   sample_geomcollections;
...
--SELECT id, cast(ST_AsText(ST_GeometryN(geometry, 2)) AS varchar(110)) AS second_geometry
--FROM   sample_geomcollections;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(105)) AS Geometry
--FROM   sample_geometries;
...
--SELECT id, cast(ST_AsText(ST_GeomFromWKB(wkb)) AS varchar(190)) AS Geometry
--FROM   sample_geometries;
...
--SELECT id, cast(ST_AsText(ST_LineFromWKB(wkb)) AS varchar(90)) AS Line
--FROM   sample_lines;
...
--SELECT id, cast(ST_AsText(ST_LineStringN(geometry, 2)) AS varchar(110)) AS second_linestring
--FROM   sample_mlines;
...
--INSERT INTO sample_polygons(id, geometry) 
--VALUES
--    (1, ST_Polygon('polygon zm((110 120 20 3, 110 140 22 3, 120 130 26 4, 110 120 20 3))') ),
--    (2, ST_Polygon('polygon zm((0 0 40 7, 0 4 35 9, 5 4 32 12, 5 0 31 5, 0 0 40 7))') ),
--    (3, ST_Polygon('polygon zm((12 13 10 16 , 8 4 10 12, 9 4 12 11, 12 13 10 16))') );

-----------------------------------------------------------------
-- ST_MaxM(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MaxM(geometry) AS SMALLINT) AS max_measure_per_polygon
--FROM   sample_polygons;

--< TO DO >--
--How do you include the id without the SQL failing
--SELECT cast(MAX(ST_MaxM(geometry)) AS SMALLINT) AS max_measure
--FROM   sample_polygons;

-----------------------------------------------------------------
-- ST_MaxX(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MaxX(geometry) AS SMALLINT) AS max_x_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MAX(ST_MaxX(geometry)) AS SMALLINT) AS max_x_coordinate
--FROM   sample_polygons;
...
-- ST_MaxY(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MaxY(geometry) AS SMALLINT) AS max_y_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MAX(ST_MaxY(geometry)) AS SMALLINT) AS max_y_coordinate
--FROM   sample_polygons;

-----------------------------------------------------------------
-- ST_MaxZ(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST(MaxZ(geometry) AS SMALLINT) AS max_z_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MAX(ST_MaxZ(geometry)) AS SMALLINT) AS max_z_coordinate
--FROM   sample_polygons;

-----------------------------------------------------------------
-- ST_MinM(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MinM(geometry) AS SMALLINT) AS min_m_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MIN(ST_MinM(geometry)) AS SMALLINT) AS min_m_coordinate
--FROM   sample_polygons;

-----------------------------------------------------------------
-- ST_MinX(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MinX(geometry) AS SMALLINT) AS min_x_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MIN(ST_MinX(geometry)) AS SMALLINT) AS min_x_coordinate
--FROM   sample_polygons;

-----------------------------------------------------------------
-- ST_MinY(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MinY(geometry) AS SMALLINT) AS min_y_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MIN(ST_MinY(geometry)) AS SMALLINT) AS min_y_coordinate
--FROM   sample_polygons;
...
-- ST_MinZ(st_geometry)
-----------------------------------------------------------------
--SELECT id, cast(ST_MinZ(geometry) AS SMALLINT) AS min_z_coordinate_per_polygon
--FROM   sample_polygons;

--SELECT cast(MIN(ST_MinZ(geometry)) AS SMALLINT) AS min_z_coordinate
--FROM   sample_polygons;
...
--INSERT INTO sample_polygons (id, geometry) 
--VALUES
--    (1, ST_Polygon('polygon((5 5, 7 7, 5 9, 7 9, 9 11, 13 9, 15 9, 13 7, 15 5, 9 6, 5 5))') ),
--    (2, ST_Polygon('polygon((20 30, 25 35, 30 30, 20 30))', 0));

--SELECT id, cast(ST_AsText(ST_MBR(geometry)) AS varchar(150)) AS MBR
--FROM   sample_polygons;
...
--INSERT INTO sample_polygons (id, geometry) 
--VALUES
--    (1, ST_Polygon('polygon((0 0, 30 0, 40 30, 40 35, 5 35, 5 10, 20 10, 20 5, 0 0))') ),
--    (2, ST_Polygon('polygon((15 15, 15 20, 60 20, 60 15, 15 15))') ),
--    (3, ST_Polygon('polygon((115 15, 115 20, 160 20, 160 15, 115 15))') );
...
--SELECT id, cast(ST_AsText(ST_MeasureBetween(geometry, 4, 6)) AS varchar(150)) AS measure_between_4_and_6
--FROM   sample_lines;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(280)) AS multilinestring
--FROM   sample_mlines
--WHERE  id = 1110;
...
--SELECT id, cast(ST_AsText(ST_MLineFromWKB(wkb)) AS varchar(280)) AS MultiLineString
--FROM   sample_mlines
--WHERE  id = 10;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(280)) AS MultiPoint
--FROM   sample_mpoints
--WHERE  id = 1110;
...
--SELECT id, cast(ST_AsText(ST_MPointFromWKB(wkb)) AS varchar(100)) AS MultiPoint
--FROM   sample_mpoints
--WHERE  id = 10;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(350)) AS MultiPolygon
...
--SELECT id, cast(ST_AsText(ST_MPolyFromWKB(wkb)) AS varchar(320)) AS MultiPolygon
--FROM   sample_mpolygons
--WHERE  id = 10;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(90)) AS MultiPoint
--FROM   sample_mpoints
--WHERE  id = 1110;
...
--    ('st_linestring', ST_LineString('linestring(2 5, 21 3, 23 10)') ),
--    ('st_polygon', ST_Polygon('polygon((110  120,  110 140, 120 130, 110 120))') );

--SELECT spatial_type, ST_NumPoints(geometry) AS number_of_points
--FROM   sample_geometries;
...
--VALUES
--    (1, ST_LineString('linestring z (0 10 1, 0 0 3, 10 0 5, 10 10 7)') );
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(35)) AS Points
--FROM   SAMPLE_POINTS;
...
--INSERT INTO sample_polygons(id, geometry)
--VALUES
--    (1110, ST_Polygon('polygon((50 20, 50 40, 70 30, 50 20))') );

--SELECT id, cast(ST_AsText(geometry) AS varchar(120)) AS polygons
--FROM   sample_polygons;

--===============================================================
-- ST_PolyFromText(GeoJSON)
--===============================================================
--DROP TABLE sample_polygons;
--CREATE TABLE sample_polygons(id SMALLINT, geometry ST_POLYGON);
...
--INSERT INTO sample_polygons(id, geometry)
--VALUES
--    (1110, ST_Polygon('{ "type": "polygon", "coordinates" : [[[50, 20], [50, 40], [70, 30], [50, 20]]] }') );
...
--INSERT INTO sample_polygons(id, geometry) 
--VALUES
--    (1115, ST_Polygon('polygon((50 20, 50 40, 70 30, 50 20))') );

--UPDATE sample_polygons AS temp_correlated
--SET    wkb = ST_AsBinary(geometry)
--WHERE  id = temp_correlated.id;

--SELECT id, cast(ST_AsText(ST_PolyFromWKB(wkb)) AS varchar(120)) AS Polygon
--FROM   sample_polygons
--WHERE  id = 1115;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(280)) AS Polygon
--FROM   sample_polygons;
...
--SELECT id, cast(ST_AsText(ST_PolygonN(geometry, 2)) AS varchar(120)) AS polygon_n
--FROM   sample_mpolygons
--WHERE  id = 1;
...
--SELECT id, cast(ST_AsText(ST_ToGeomColl(geometry)) AS varchar(120)) AS geometry_collections
--FROM   sample_geometries;
...
--SELECT cast(ST_AsText(geometry) AS varchar(35)) AS points
--FROM   sample_geometries;

--SELECT cast(ST_AsText(ST_ToPoint(geometry)) as varchar(35)) AS points
--FROM   sample_geometries;

--SELECT cast(ST_AsText(TREAT(geometry AS ST_Point)) as varchar(35)) AS points
--FROM   sample_geometries;
...
--INSERT INTO sample_geometries(id, geometry)
--VALUES
--    (1, ST_Geometry('linestring z (0 10 1, 0 0 3, 10 0 5)')),
--    (2, ST_Geometry('point empty', 1)),
--    (3, ST_Geometry('multipolygon empty', 1));


--SELECT cast(ST_AsText(ST_ToLineString(geometry)) as varchar(130)) AS lines
--FROM   sample_geometries;
...
--SELECT cast(ST_AsText(ST_ToPolygon(geometry)) as varchar(130)) AS polygons
--FROM   sample_geometries;
...
--SELECT cast(ST_AsText(ST_ToMultiPoint(geometry)) as varchar(100)) AS MultiPoint
--FROM   sample_geometries;
...
--    (12, ST_Polygon('polygon((50 20, 50 40, 70 30, 50 20))') );

--UPDATE sample_geometries AS temp_correlated
--SET    wkb = ST_AsBinary(geometry)
--WHERE  id = temp_correlated.id;

--SELECT id, cast(ST_AsText(ST_WKBToSQL(wkb)) AS varchar(120)) AS Geometries
--FROM   sample_geometries;
...
--SELECT id, cast(ST_AsText(geometry) AS varchar(120)) AS Geometries
--FROM   sample_geometries;
...
--SELECT id, ST_X(geometry) AS x_coordinate
--FROM   sample_points;
...
--SELECT id, ST_Y(geometry) AS y_coordinate
--FROM   sample_points;
...
--SELECT id, ST_Z(geometry) AS z_coordinate
--FROM   sample_points;
...
--===============================================================
-- ST_Grandmbr and ST_Union aggregate geometries
--===============================================================
--DROP TABLE sample_points;
--CREATE TABLE sample_points(id SMALLINT, geometry ST_POINT);
...
--SELECT cast(ST_AsText(ST_Grandmbr(geometry)) AS varchar(160)) AS aggregate_of_points
--FROM sample_points;

--SELECT cast(ST_AsText(ST_ConvexHull(ST_Union(geometry))) AS varchar(110)) AS aggregate_of_points
--FROM sample_points;
