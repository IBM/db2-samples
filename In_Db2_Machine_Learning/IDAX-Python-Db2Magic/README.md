...
* [Building an In-database Linear Regression Model using IDAX SPs of Db2.ipynb](Building an In-database Linear Regression Model using IDAX SPs of Db2.ipynb)
